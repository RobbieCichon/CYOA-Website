...
function Room4(){
	if (CheckCookie('lookatnote')){
		...
		http.onreadystatechange = function(){
			if (this.readyState === 4 && this.status === 200) {
				document.getElementById('storage').innerHTML = this.responseText;}};
		http.open('GET', 'js/txt/Room4B.txt', true);
		http.send();
	}
		...
		http.onreadystatechange = function(){
			if (this.readyState === 4 && this.status === 200) {
				document.getElementById('storage').innerHTML = this.responseText;}};
		http.open('GET', 'js/txt/Room4E2.txt', true);
		http.send();
	}
	else if (CheckCookie('R4M')){
		let http = new XMLHttpRequest();
		http.onreadystatechange = function(){
			if (this.readyState === 4 && this.status === 200) {
				document.getElementById('storage').innerHTML = this.responseText;}};
		http.open('GET', 'js/txt/Room4M.txt', true);
		http.send();
	}
		...
		http.onreadystatechange = function(){
			if (this.readyState === 4 && this.status === 200) {
				document.getElementById('storage').innerHTML = this.responseText;}};
		http.open('GET', 'js/txt/Room4E.txt', true);
		http.send();
	}
	else if (CheckCookie('R4M2')){
		let http = new XMLHttpRequest();
		http.onreadystatechange = function(){
			if (this.readyState === 4 && this.status === 200) {
				document.getElementById('storage').innerHTML = this.responseText;}};
		http.open('GET', 'js/txt/Room4B2.txt', true);
		http.send();
	}
}
Room4();